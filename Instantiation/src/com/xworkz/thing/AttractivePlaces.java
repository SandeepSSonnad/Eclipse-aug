...
public class AttractivePlaces {
    ...
    public AttractivePlaces(String name,char type,String place,int  noOfPlace,boolean correctLocation,String[] placeNames,String[] placeLocation,String[] members,double[] price,long[] totalTouristVisited,String[] otherCountryNameswhoVisit)
