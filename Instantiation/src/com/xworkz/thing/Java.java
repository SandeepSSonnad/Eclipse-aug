...
public class Java {
    ...
    public Java(String name,String type,String invented,int  types,boolean freeToUse,String[] placeNames,String[] placeLocation,String[] members,double[] price,long[] totalUserOtherCountry,String[] countryNames)
