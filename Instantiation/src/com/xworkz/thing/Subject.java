...
public class Subject {
	 public String    name;
	    ...
	    public Subject(String name,String type,String invented,int  types,boolean freeToLearn,String[] typesOfSubjects,String[] typesOfExams,String[] typesOfMarks,double[] fee,long[] totalStudentsInCountry,String[] countryNames)
	    {
	   	 this.name = name;
	   	 this.type = type;
