...
public class TextBook {
	 ...
	 public String    name;
	    ...
	    public TextBook(String name,String type,String writer,int  types,boolean freeToWrite,String[] typesOfBooks,String[] writerNames,String[] typesOfDesign,double[] price,long[] totalStudentsUsedBooks,String[] countryMostBookUsed)
	    {
	   	 this.name = name;
	   	 this.type = type;
	   	 this.writer = writer;
