...
public class Website {
    ...
    public Website(String name,char type,String actorName,int  noOfActors,boolean hit,String[] seriesName,String[] episodeNames,String[] characterNames,double[] budget,long[] noOfSeasons,String[] musicNames) 
    {
   	 this.name = name;
   	 this.type = type;
